'*********************************************************************************
'*                                                                               *
'*         T H I S   F I L E   I S   P A R T   O F   B A S C O M                 *
'*                                                                               *
'*         P A C K A G E   A N D   W A S    N O T    W R I T T E N  *            *
'*                                          ----------------------               *
'*         B Y   T H E   C O N T E S T    E N T R A N T                          *
'*                                                                               *
'*********************************************************************************

'                   (*) Except changing configuration values
...
' Config File-System for Version 5.4:
' Needs BASCOM-AVR 1.11.8.1 or higher

' === User Settings ============================================================

' Count of file-handles, each file-handle needs 524 Bytes of SRAM
Const Cfilehandles = 2                                      ' [default = 2] changed for mega32
...
Const Csepfathandle = 1                                     ' [default = 1] changed fom mega32
