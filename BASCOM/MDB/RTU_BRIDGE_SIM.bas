...
Led1 Alias Porta.7                                          'LED ROJO
Config Led1 = Output

Ledmdb Alias Portd.5
...
'* Archivos incluidos
'*******************************************************************************
$include "RTU_BRIDGE_SIM_archivos.bas"
$lib "modbus.lbx"
...
Do
   ...
   If Newtxper = 1 Then
      Print #1 , "NEW tx=";
      Reset Newtxper
      Cntrestaciones = Cntrestaciones Mod 16
      Cntrestaciones = Tonotest
      Print #1 , Cntrestaciones
      Dout0 = Cntrestaciones.0
      Dout1 = Cntrestaciones.1
      Dout2 = Cntrestaciones.2
      Dout3 = Cntrestaciones.3
