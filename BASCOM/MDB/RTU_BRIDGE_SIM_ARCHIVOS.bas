...
Int_timer0:
   ...
   If Cntrt0 = 0 Then                                       'Ints cada segundo
      Incr Cntrtxper
      Cntrtxper = Cntrtxper Mod Trqs
      If Cntrtxper = 0 Then
         Set Newtxper
         'Incr Cntrtx
      End If
...
For For_loop = 1 To 32
   ...
   Input_registers_table(for_loop) = 0
Next For_loop
         ...
         Case "TSTSTA"
            If Numpar = 3 Then
               ...
               If Statst < 12 Then
                  ...
                  If Estadotst < 4 Then
                     Cmderr = 0
                     Atsnd = "TST Tx Estacion=" + Str(statst) + " , STATUS=" + Str(estadotst)
                     Set Newtst
                  Else
                     Cmderr = 6
                  End If
